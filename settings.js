...
module.exports = {
    OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94779062397' : process.env.OWNER_NUMBER,    SESSION_ID: process.env.SESSION_ID === undefined ? '' : process.env.SESSION_ID, 𝕃𝔸ℝ𝔸-𝕄𝔻=ndZRBJrK#7YcrhvEiAh3CwYsGXdh9expl708kv53qZKizRaLZhxw
